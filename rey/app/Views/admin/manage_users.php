...
<body>
    ...
    <div class="main-content">
        <h1>Manage Users</h1>
        <a href="/admin/create-user"><i class="fas fa-user-plus"></i> Create New User</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $user['role'] ?></td>
                    <td class="actions">
                        <a href="/admin/edit-user/<?= $user['id'] ?>"><i class="fas fa-edit"></i> Edit</a>
                        <a href="/admin/delete-user/<?= $user['id'] ?>" onclick="return confirm('Are you sure?')"><i class="fas fa-trash-alt"></i> Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
